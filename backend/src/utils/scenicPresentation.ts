...
export type ScenicPresentation = {
...
const cityImageBank: Record<string, ScenicAsset[]> = {
  ...
  武汉: [
    { url: 'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?auto=format&fit=crop&w=1400&q=80', theme: '湖畔风光' },
  ...
  苏州: [
    { url: 'https://images.unsplash.com/photo-1472396961693-142e6e269027?auto=format&fit=crop&w=1400&q=80', theme: '园林意境' },
    { url: 'https://images.unsplash.com/photo-1521295121783-8a321d551ad2?auto=format&fit=crop&w=1400&q=80', theme: '水巷慢行' },
  ],
};
...
const categoryImageBank: Record<string, ScenicAsset[]> = {
  ...
  文化古迹: [
    { url: 'https://images.unsplash.com/photo-1528164344705-47542687000d?auto=format&fit=crop&w=1400&q=80', theme: '古迹巡礼' },
    { url: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=1400&q=80', theme: '历史地标' },
  ],
  自然风光: [
    { url: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1400&q=80', theme: '自然疗愈' },
    { url: 'https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=1400&q=80', theme: '山水慢游' },
  ],
  主题公园: [
    { url: 'https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?auto=format&fit=crop&w=1400&q=80', theme: '欢乐游线' },
    { url: 'https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=1400&q=80', theme: '周末放松' },
  ],
};
...
const fallbackAssets: ScenicAsset[] = [
  ...
  { url: 'https://images.unsplash.com/photo-1528164344705-47542687000d?auto=format&fit=crop&w=1400&q=80', theme: '人文古迹' },
];
...
const hasValidCover = (scenic: ScenicPresentable) => {
